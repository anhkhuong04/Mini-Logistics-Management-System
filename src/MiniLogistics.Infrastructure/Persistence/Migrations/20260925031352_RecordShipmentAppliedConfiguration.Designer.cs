...
namespace MiniLogistics.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925031352_RecordShipmentAppliedConfiguration")]
    partial class RecordShipmentAppliedConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniLogistics.Domain.AdminAuditing.AdminAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Banners.Banner", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Operations.Hub", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsRegionalSortingHub")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Operations.ShipperWorkingArea", b =>
                {
                    ...
                    b.HasIndex("ShipperId", "HubId", "Ward", "ZoneCode")
                        .IsUnique()
                        .HasFilter("[IsActive] = 1");
            ...
            modelBuilder.Entity("MiniLogistics.Domain.PartnerApi.PartnerApiRequestAudit", b =>
                {
                    ...
                    b.Property<bool>("IsIdempotentReplay")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Shipments.Shipment", b =>
                {
                    ...
                    b.Property<Guid?>("AppliedFeeRuleId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("AppliedFeeRuleVersion")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("DeliveryRouteRegionConfigId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("DeliveryRouteRegionConfigVersion")
                        .HasColumnType("int");
                    ...
                    b.Property<Guid?>("PickupRouteRegionConfigId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("PickupRouteRegionConfigVersion")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AppliedFeeRuleId");

                    b.HasIndex("CreatedAtUtc");

                    b.HasIndex("DeliveryRouteRegionConfigId");

                    b.HasIndex("PickupRouteRegionConfigId");
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Shipments.ShipmentImportBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ShipmentImportBatches", (string)null);
                });

            modelBuilder.Entity("MiniLogistics.Domain.Shipments.ShipmentImportBatchRow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsValidAtSubmission")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ShopId", "ClientOrderCode", "Status");

                    b.ToTable("ShipmentImportBatchRows", (string)null);
                });
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Shops.ShopNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShopId", "UserId", "IsRead", "CreatedAtUtc");

                    b.ToTable("ShopNotifications", (string)null);
                });

            modelBuilder.Entity("MiniLogistics.Domain.Shops.ShopNotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ShopNotificationPreferences", (string)null);
                });

            modelBuilder.Entity("MiniLogistics.Domain.Shops.ShopStaffMembership", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("CreatedByOwnerUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CreatedByOwnerUserId");
                    ...
                    b.ToTable("ShopStaffMemberships", (string)null);
                });
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Operations.ShipperWorkingArea", b =>
                {
                    b.HasOne("MiniLogistics.Domain.Operations.Hub", null)
                        .WithMany()
                        .HasForeignKey("HubId")
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Shipments.Shipment", b =>
                {
                    b.HasOne("MiniLogistics.Domain.Fees.FeeRule", null)
                        .WithMany()
                        .HasForeignKey("AppliedFeeRuleId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MiniLogistics.Domain.Operations.RouteRegionConfig", null)
                        .WithMany()
                        .HasForeignKey("DeliveryRouteRegionConfigId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MiniLogistics.Domain.Operations.RouteRegionConfig", null)
                        .WithMany()
                        .HasForeignKey("PickupRouteRegionConfigId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Shipments.ShipmentImportBatchRow", b =>
                {
                    b.HasOne("MiniLogistics.Domain.Shipments.ShipmentImportBatch", null)
                        .WithMany("Rows")
            ...
            modelBuilder.Entity("MiniLogistics.Domain.Shops.ShopStaffMembership", b =>
                {
                    b.HasOne("MiniLogistics.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("CreatedByOwnerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
